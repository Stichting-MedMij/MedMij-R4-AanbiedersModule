...
## Algemeen
Aanbiedertaken (ProviderTasks) beschrijft de uitwisseling waarmee een zorgaanbieder patiënt-specifieke digitale activiteiten als taken beschikbaar stelt aan een patiënt, zodat de patiënt deze kan uitvoeren (bijvoorbeeld via een Persoonlijke Gezondheidsomgeving (PGO) of een andere eHalth-module).
