...
| ContactInformation.TelephoneNumber | +31612345600 (mobiel) |
| ContactInformation.EmailAddress | tomvanduinen@tom.com |
| PatientIdentificationNumber (BSN) | 999990188  |
...
| ContactInformation.TelephoneNumber | +31612345600 |
| ContactInformation.EmailAddress | dehaard@huisarts.nl |
...
> Note: the patient-specific schedule for *Bloedglucose meting volgens NHG protocol* is taken from the execution order, not from the digital activity. The activity-level timing is informative for the healthcare professional only.
