...
<ul>
  ...
  <li class="toc-sub"><a href="#measurement-tasks-bloedglucosemeting">Measurement tasks (Bloedglucosemeting)</a></li>
</ul>
</div>
<!-- AUTO-TOC:END -->
...
| HealthProfessionalIdentificationNumber (BIG) | 12070100321 (in identifier system 'http://fhir.nl/fhir/NamingSystem/big') |
