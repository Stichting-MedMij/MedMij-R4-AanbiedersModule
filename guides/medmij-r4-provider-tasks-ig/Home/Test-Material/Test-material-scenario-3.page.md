...
| ContactInformation.TelephoneNumber | +31655501234 (mobiel) |
| ContactInformation.EmailAddress | sanne.vandijk@voorbeeldmail.nl |
| PatientIdentificationNumber (BSN) | 999990206 |
...
| ContactInformation.TelephoneNumber | +31655506789 |
| ContactInformation.EmailAddress | m.vanrijn@huisartspraktijk-example.nl |
...
| Schedule.Period | 05-01-2026 t/m 11-01-2026 |
| Schedule.Frequency | 1 keer per dag |
| Requester | M. van Rijn, Huisarts |
...
The COPD module results in **10 patient-facing tasks**, all assigned to *Sanne van Dijk* and grouped under the digital group plan *Digitale zorgmodule COPD*. All tasks have requester *M. van Rijn, Huisarts*.
