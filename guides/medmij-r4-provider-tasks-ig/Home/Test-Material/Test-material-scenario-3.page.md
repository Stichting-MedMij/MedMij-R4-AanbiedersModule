...
<ul>
  ...
  <li class="toc-sub"><a href="#measurement-tasks-saturatiemeting">Measurement tasks (Saturatiemeting)</a></li>
</ul>
</div>
<!-- AUTO-TOC:END -->
...
| HealthProfessionalIdentificationNumber (BIG) | 19078234684 (in identifier system 'http://fhir.nl/fhir/NamingSystem/big') |
...
### Measurement tasks (Saturatiemeting) {#measurement-tasks-saturatiemeting}
