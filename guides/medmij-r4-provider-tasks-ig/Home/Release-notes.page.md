...
| Technical design | Task search guidance has been updated: Tasks in scope SHALL be filtered using `_tag=http://medmij.nl/fhir/CodeSystem/DataService|urn:oid:2.16.528.1.1023.5.6`. Guidance on resolving secondary resources and `_include` has been clarified. | [TOOLBOX1-896](https://medmij.atlassian.net/browse/TOOLBOX1-896) |
